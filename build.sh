...
xcrun clang -fobjc-arc -O2 -Wall -Wextra -Werror -Wno-unused-parameter \
  -arch arm64 -arch x86_64 -mmacosx-version-min=14.4 -framework Cocoa -framework CoreAudio -framework Security \
...
xcrun clang -fobjc-arc -O2 -Wall -Wextra -Werror -arch arm64 -arch x86_64 -mmacosx-version-min=14.4 -framework Foundation -framework CoreAudio uninstaller/RestoreAudio.m -o "$app/Contents/Resources/Uninstaller/RestoreAudio"
