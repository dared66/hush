...
#define kPlugIn_BundleID "local.hush.AudioDevice"
#define kBox_UID "HushAudioBox_UID"
#define kDevice_UID "HushAudioDevice_UID"
#define kDevice_ModelUID "HushAudioDevice_ModelUID"
...
class ProxyAudioDevice {
  public:
    ...
    std::atomic<bool> outputDeviceReady{false};
